...
public class PokeWorld extends JPanel {
    ...
    /**
     * Draw all the types
     * @param g I have no idea you guys wrote this code and should've done the
     *          javadocs correctly in the first place
     */
    ...
    private class ClickListener extends MouseAdapter {
        public void mousePressed(MouseEvent e) {
            ...
            if (types.size() < 1100) {
                ...
                }  else if (pokemonSpecies.equals("Sterling")) {
                    types.add(new Sterling(p.x, p.y, bounds));
                }
            }
