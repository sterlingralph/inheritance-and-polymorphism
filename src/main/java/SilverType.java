...
/**
 * A Silver type pokemon
 *
 * @author sralph3
 * @version 1
 */

public abstract class SilverType extends Pokemon {
     ...
     */
    public SilverType(int x, int y, Rectangle bounds) {
        super(x, y, bounds);
    }
    ...
    public void move() {
        ...
        boolean isSilver = ((this.getXPos() > (rect.width) / 2)
